...
% mostrar una fotico de alguna región de formación estelar
...
% mostrar Fig. 3 Krumholz+2014
% mostrar Figs. 6 y 7 Kennicutt+1998b
...
metalicidad del MIE.
% mostrar Fig. 12 Kennicutt+2012 donde se ve que las regiones de baja metalicidad tienen baja eficiencia también
% revisar bolatto+2011
...
% revisar Leroy+2008 y evans+2009
...
% disco con regiones de formación estelar
% en las regiones de formación estelar, mostrar nubes moleculares
% mostrar la estructura de las nubes moleculares (Fig. 9 Krumholz+2014). Resaltar regiones de mayor extinción
% mostrar el efecto de la turbulencia en la eficiencia con campo de velocidades
% mostrar el efecto de escudo del polvo para evitar la disociación del H_2 por parte de FUV
% mostrar estrellas recien formadas
% mostrar FUV, feedback estelar: radiativo y mecánico
% mostrar disipasión y calentamiento de la nube molecular
% mostrar aumento de la metalicidad comparando especies químicas en t=0 con las especies después de
% una generación estelar
% mostrar enfriamiento con nueva metalicidad en una escala t mas corta que en t=0
...
% mostrar Fig. 2 Qu+2016 Notar que una predicción fundamental es que la fusión de halos masivos es poco frecuente
