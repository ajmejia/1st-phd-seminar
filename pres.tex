...
\column{0.7\textwidth}
\begin{figure}
\includegraphics<1>[scale=0.3]{img/hudf}
\includegraphics<2>[scale=0.3]{img/hudf-inset}
\includegraphics<3>[scale=0.3]{img/hudf-proj}
\end{figure}
\column{0.3\textwidth}
rangos dinámicos:
...
\end{subequations}
\end{columns}
% 1: imagen de un campo de galaxias
% 2: zoom hacia una galaxia eliptica
% 3: mostrar estructura 3D y sus proyecciones en 2D
% 4: mostrar imagen 2D CALIFA
% 5: mostrar ejes x,y,lambda
\end{frame}
...
% mostrar los 3 reservorios, como se conectan
\begin{figure}
\includegraphics[scale=1]{img/placeholder}
% \includegraphics[scale=1]{img/reservoir-diagram} %************************************************
\end{figure}
\end{frame}
