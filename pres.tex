\documentclass[xcolor=dvipsnames,fleqn,hyperref={colorlinks,citecolor=black,linkcolor=black,urlcolor=black}]{beamer}
...
\begin{figure}
\includegraphics[scale=0.7]{img/placeholder}
\end{figure}
