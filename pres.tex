...
% mostrar la relación de Schmidt y la de Kennicutt-Schmidt
$$
\dot{\rho}_\star = \epsilon_\star\,\frac{\rho_\text{gas}}{t_\star}\propto{\rho_\text{gas}}^{1.5},
$$
%
e imponer un conjunto de reglas (condiciones) físicas para su activación. Una de estas reglas, es la
escala de tiempo, $t_\star$, en que la formación estelar ocurre localmente. Esta escala temporal
depende de las propiedades físicas del gas y puede ser función de la escala dinámica, la escala
térmica y/o de la escala para la formación de ciertas especies moleculares (e.\,g. H$_2$).
Ciertamente, aún no está claro si alguno de los procesos físicos que involucra adoptar una escala
temporal u otra, es preponderante en la formación estelar y bajo qué circunstancias lo es.
