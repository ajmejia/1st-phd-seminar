...
\node<2-3>[circle,draw=black!50,very thick,inner sep=2mm] (pag) at (7.5+4.08,0.79-1) {};
\node<3-3>[circle,draw=black!50,very thick,inner sep=2mm] (sfg) at (7.5+4.43,4.43-1) {};
...
\path<2-3>[draw=black!50,very thick] (pag.east) -- (pag-inset.west);
\path<3-3>[draw=black!50,very thick] (sfg.east) -- (sfg-inset.west);

\node<2-5>[nt,right=of pag-inset]       (pag-text) {\textsc{galaxia temprana}};
\path<2-5>[-|,draw=black!50,very thick] (pag-inset.east) -- (pag-text.west);

\node<3->[nt,right=of sfg-inset]       (sfg-text) {\textsc{galaxia tardía}};
\path<3->[-|,draw=black!50,very thick] (sfg-inset.east) -- (sfg-text.west);
...
\node<5>[nt,left=2cm of pag-mock] (pag-desc) {\textsc{
...
\end{itemize}
\end{varwidth}}};
\node<5>[nt,left=2cm of sfg-mock] (sfg-desc) {\textsc{
\begin{varwidth}{0.3\textwidth}
\begin{itemize}
...
\node<7->[nt,left=of sf-region,text width=0.25\textwidth] (sf-region-text) {\textsc{región de formación estelar}};
\path<7->[draw=black!50,very thick]    (sfg-mock)       -- (sf-region);
\path<7->[-|,draw=black!50,very thick] (sf-region.west) -- (sf-region-text.east);

\node<8->[nt,below=4cm of sf-region,label=90:\textsc{moléculas}]   (molecule)    {\includegraphics[scale=0.5]{img/molecule}};
\node<8->[nt,left=2cm of molecule,label=90:\textsc{polvo}]         (dust)        {\includegraphics[scale=0.5]{img/dust}};
\node<8->[nt,left=2cm of dust,label=90:\textsc{estrellas jóvenes}] (stars)       {\includegraphics[scale=0.5]{img/stars}};
\node<8->[nt,right=2cm of molecule,label=90:\textsc{H\,i y H}$_2$] (h-molecular) {\includegraphics[scale=0.5]{img/h-molecular}};
\node<8->[nt,right=2cm of h-molecular,label=90:\textsc{iones}]     (ions)        {\includegraphics[scale=0.5]{img/ions}};
\path<8->[draw=black!50,very thick] (sf-region.south) -- (molecule.north);
\path<8->[draw=black!50,very thick] (sf-region.south) -- (dust.north);
\path<8->[draw=black!50,very thick] (sf-region.south) -- (stars.north);
\path<8->[draw=black!50,very thick] (sf-region.south) -- (h-molecular.north);
\path<8->[draw=black!50,very thick] (sf-region.south) -- (ions.north);

\node<9>[nt,text width=10cm] (pag-desc) at (25,-5) {\alert{Procesos físicos relevantes ocurren en un rango dinámico de $\sim10^{30}\,$m.}};
