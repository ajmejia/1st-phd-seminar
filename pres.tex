...
\path[->,draw,very thick] (0,0) -- node[near end,below,sloped]     {edad media}          (10,0);
\path[->,draw,very thick] (0,0) -- node[near end,above,sloped]     {evolución espectral} (0,10);
\path[->,draw,very thick] (0,0) -- node[near end,below=1cm,sloped] {metalicidad media}   (7,7);
...
% Fig. 1 Mannucci+2010.
\begin{figure}
\flushleft\scriptsize\citep{Mannucci2010}
\includegraphics[width=\textwidth]{img/mannucci2010-1}
\end{figure}
...
\setlength\itemsep{0.5em}
\item La dispersión en la relación $M_\star\,$--$\,Z$ se debe a distintos niveles de $\Psi$,
\item a $M_\star$ fija:
\begin{itemize}\scriptsize
\item galaxias $\log{M_\star/\text{M}_\odot}<10.5$ forman una secuencia en $\Psi\,$--$\,Z_\text{frío}$,
\item galaxias $\log{M_\star/\text{M}_\odot}>10.5$ no muestran dependencia fuerte $\Psi\,$--$\,Z_\text{frío}$.
\end{itemize}
\alert{\item La dependencia $\Psi\,$--$\,Z_\text{frío}$ puede explicarse como un efecto de apertura fija e inclinación.}
\end{itemize}
...
\begin{figure}
\includegraphics[scale=1]{img/text4732}
\end{figure}
...
% Fig. 1 Mannucci+2010.
\begin{figure}
\flushleft\scriptsize\citep{Mannucci2010, Sanchez2017}
\includegraphics[width=\textwidth]{img/mannucci2010-1}
\end{figure}
...
\uncover<2->{
\begin{figure}
\includegraphics[width=\textwidth]{img/sanchez2017-4}
\end{figure}}
...
\begin{frame}{\textsc{ciclo de masa --- un modelo de juguete}}
