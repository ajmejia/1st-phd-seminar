...
\node<8->[below=4cm of sf-region,label=90:\textsc{moléculas}]   (molecule)    {\includegraphics[scale=0.5]{img/molecule}};
\node<8->[left=2cm of molecule,label=90:\textsc{polvo}]         (dust)        {\includegraphics[scale=0.5]{img/dust}};
\node<8->[left=2cm of dust,label=90:\textsc{estrellas jóvenes}] (stars)       {\includegraphics[scale=0.5]{img/stars}};
\node<8->[right=2cm of molecule,label=90:\textsc{H\,i y H}$_2$] (h-molecular) {\includegraphics[scale=0.5]{img/h-molecular}};
\node<8->[right=2cm of h-molecular,label=90:\textsc{iones}]     (ions)        {\includegraphics[scale=0.5]{img/ions}};
...
\node<9->[nt,below=3mm of h-molecular] {$\sim\unit[10]{\AA}$};

\end{tikzpicture}
\end{frame}

\begin{frame}{\textsc{motivación}}
% mostrar ciclo de masa
\end{frame}
