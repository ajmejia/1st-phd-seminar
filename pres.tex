...
\begin{description}
%
\item[\textsc{Fenómenos relevantes y sus escalas.}] Los fenómenos dinámicos son probablemente los
más fundamentales, así que en adelante la masa estelar (como aproximación de la masa bariónica) y su
densidad superficial serán consideradas cantidades fundamentales en el ciclo de masa. La masa sola
contiene información global sobre la dinámica de la galaxia, mientras que la densidad superficial
contiene información local, más aún está directamente relacionada con la formación estelar en discos
de gas frío.

La capacidad del material bariónico en fase de gas de radiar su energía interna define la escala
temporal radiativa típica, en la que material del reservorio caliente se mueve al frío.

La formación estelar define la escala típica en que el material del reservorio frío se mueve al
reservorio estelar.

Estos son los datos del problema que consiste en responder a las preguntas: ¿en qué escala temporal
ocurre el enriquecimiento químico? y más importante aún ¿por qué este parece ser independiente de la
TFE?
